...
module.exports = (webpackEnv) => {
      ...
      rules: [
        ...
        { parser: { requireEnsure: false } },
        {
          ...
          oneOf: [
            ...
            // Transform handlebars files
            {
              test: /\.hbs$/,
              loader: require.resolve('handlebars-loader') + '?helperDirs[]=' + paths.appSrc + '/helpers'
            },
  ...
  const ctx = {
    ...
    workspaces,
    paths,
    findLoader: (loaderName) => findLoader(webpackConfig, loaderName)
  }

  workspaces
    .paths
    .concat(paths.appPath)
    .forEach((packagePaths) => {
      const file = path.join(packagePaths, 'webpack.override.js')
      if (fs.existsSync(file)) {
        webpackConfig = require(file)(webpackConfig, ctx)
      }
    })
