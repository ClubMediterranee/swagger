...
export function HeroBanner(props: System) {
  ...
  return (
    <div className="relative xl:pb-0 sm:py-20 lg:py-40 text-black">
      ...
      {showBanner ? (
        <div className="api-banner sm:grid sm:grid-cols-2 lg:grid-cols-5 -mb-24 wrapper">
          ...
          <div className="-mt-24 flex flex-col sm:col-span-2 lg:col-span-3 sm:col-start-1 sm:row-start-1 sm:mt-0 sm:justify-center sm:gap-y-20 lg:gap-y-40">
            <div className="sm:max-w-1/2 lg:max-w-full flex flex-col gap-y-20 px-20 py-40 sm:-order-1 sm:p-0 sm:pe-20 lg:pe-40 xl:pe-80">
              ...
              <div className="text-b3">
                ...
                you're looking for destination details, making reservations, or discovering the latest promotions, the Club Med API ensures
                a streamlined user experience. Step into this digital realm and amplify your platforms with the Club Med API.
              </div>
