...
function deprecated(depreciation: any): string {
  ...
  return `<div class="bg-white p-8 mt-8 rounded-8 border-2 text-red border-red">
    ...
    <div>
        ...
        <br />See more details on our migration note <strong><a href="https://portal.api.clubmed/migration-notes/${depreciation.discussion_id}" target="_blank">here</a></strong>.
    </div>
</div>`;
}
