...
describe("useScrollLock()", () => {
  ...
  it("initially locks and unlocks body", () => {
  ...
  it("initially locks and unlocks the target element", () => {
  ...
  it("initially locks and unlocks the target element by selector", () => {
    const target = document.createElement("div");
  ...
  it("does not initially lock and unlock", () => {
  ...
  it("keep the original style of the target element when it's unlocked", () => {
    const target = document.createElement("div");
  ...
  it("unlocks on unmount even with initial is locked", () => {
  ...
  it("fallback to document.body if the target element is not found", () => {
  ...
  it("add padding-right to prevent width reflow", () => {
    const { unmount } = renderHook(() => useScrollLock());
