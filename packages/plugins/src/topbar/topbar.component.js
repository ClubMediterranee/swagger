...
import { parseSearch, serializeSearch } from '@reswagger/utils'
// import "./topbar.less"
...
export default class Topbar extends React.Component {
  ...
  render () {
    ...
    if (urls) {
      ...
      control.push(<input className="download-url-input" type="text" onChange={this.onUrlChange} value={this.state.url}
